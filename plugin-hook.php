...
Description: Manage and present students grade results. A derived work from Studentmanager plugin by Kolja Schleich.
Version: 1.1
Author: Carlos Ruiz
...
add_action( 'widgets_init', array(&$gradebook, 'activateWidget') );

// Ajax Actions
add_action( 'wp_ajax_gradebook_show_grade_date_selection', 'gradebook_show_grade_date_selection' );
